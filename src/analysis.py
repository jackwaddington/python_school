...
Run after main.py has produced weekly_stats.csv and students.csv.
...
weekly = pd.read_csv("weekly_stats.csv", parse_dates=["date"])
...
# 1. Weekly active / graduates / dropouts over time
ax = axes[0, 0]
...
plt.tight_layout()
plt.savefig("simulation_report.png", dpi=150)
